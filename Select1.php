...
$sql="SELECT * FROM Usuarios U join Asistencia a on a.idUsuarios =U.idUsuarios";
if($result = mysqli_query($conn,$sql)){
	echo "<table><tr><td id='Primer'>"."idUsuarios"."</td><td id='Segundo'>"."Nombre"."</td><td id='Tercer'>"."Time"."</td></tr>";
    	while($row=mysqli_fetch_assoc($result)){
    		echo "<tr><td id='Primer'>".$row['idUsuarios']."</td><td id='Segundo'>".$row['Nombre']."</td><td id='Tercer'>".$row['Time']."</td></tr>";
    	}echo "</table>";
